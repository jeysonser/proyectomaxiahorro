package utp.edu.pe.controlador;

import utp.edu.pe.config.Fecha;
import utp.edu.pe.modelo.Carrito;
import utp.edu.pe.modelo.Categoria;
import utp.edu.pe.modelo.Cliente;
import utp.edu.pe.modelo.ClienteDAO;
import utp.edu.pe.modelo.Compra;
import utp.edu.pe.modelo.ComprasDAO;
import utp.edu.pe.modelo.DetalleCompra;
import utp.edu.pe.modelo.Pago;
import utp.edu.pe.modelo.Producto;
import utp.edu.pe.modelo.ProductoDAO;
import utp.edu.pe.modelo.Rol;
import utp.edu.pe.modelo.Tarjeta;
import java.io.File;
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            File file = new File("C:\\Users\\WINDOWS\\Desktop\\Maxi_Ahorro\\web\\img\\productos\\" + fileItem.getName());
                            fileItem.write(file);
                ...
                try {
                    ...
                    for (int i = 0; i < items.size(); i++) {
                        ...
                        if (!fileItem.isFormField()) {
                            ...
                            if (!"".equals(nomfoto)) {
                                File file = new File("C:\\Users\\WINDOWS\\Desktop\\Maxi_Ahorro\\web\\img\\fotouser\\" + fileItem.getName());
                                fileItem.write(file);
