...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: red">
            ...
            <a class="navbar-brand" style="color: white" href="#" data-toggle="dropdown"><img class="logo" src="https://images.weare365.io/filters:format(.webp)/1920x0/Maxi_ahorro_1517_6148d91102.png" width="100" height="50"></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="./Controlador?txtBuscar=&accion=BuscarProducto"><i class="fas fa-home"></i> Principal<span class="sr-only">(current)</span></a>
                    </li>                                 
                </ul>                                           
            </div>
        </nav>        
        ...
        <div class="container mt-4"> 
            <c:if test="${clientelogueado.idrol==1}">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModalAdd">Nuevo Usuario</button>
            </c:if>
            <hr>
                ...
                <tbody>
                        ...
                        <c:forEach var="c" items="${clientes}" varStatus="iterator" >
                            <tr class="text-center">
                               ...
                               <td><img src="${c.foto}" width="50" height="50"></td>                       
                                <td>                               
                                    <a href="#" onclick="CargarModal(${c.id})" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                    <input type="hidden" id="idCliente" value="${c.id}">
                                    <input type="hidden" id="idRol" value="${clientelogueado.idrol}">
                                    <a id="idEliminar" class="btn btn-danger" href="#"><i class="fa fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        </c:forEach> 
                    </c:if>
                    <c:if test="${clientelogueado.idrol!=1}">
                        <tr class="text-center">
                            ...
                            <td>                               
                                <a href="#" onclick="CargarModal(${clientelogueado.id})" class="btn btn-warning"><i class="fa fa-edit"></i></a>
