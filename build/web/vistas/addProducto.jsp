...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="./Controlador?accion=home"><i class="fas fa-home"></i> Principal<span class="sr-only">(current)</span></a>
                    </li>                                 
                </ul>                                           
        ...
        <div class="container mt-4">            
            <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fas fa-notes-medical"></i> Nuevo Producto</button>
            <hr>
                ...
                <tbody>
                    <c:forEach var="p" items="${productos}">
                        <tr class="text-center">
                            ...
                            <td>${p.getEstado()}</td>                           
                            <td>
                                <a href="#" onclick="CargarModal(${p.getId()})" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                <a onclick="Eliminar(${p.getId()})" class="btn btn-danger" href="#"><i class="fa fa-trash-alt"></i></a>                               
                            </td>
                        </tr>
                    </c:forEach>                           
                </tbody>
